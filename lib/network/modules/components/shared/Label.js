...
/////////////////////////////////////////////////////////
   ...
   */
  draw(ctx, x, y, selected, hover, baseline = 'middle', textStroke = true) {
    // if no label, return
    ...
    this._drawText(ctx, x, this.size.yLine, baseline, viewFontSize, textStroke);
  }
   ...
   * @private
   */
  _drawText(ctx, x, y, baseline = 'middle', viewFontSize, textStroke = true) {
    ...
    for (let i = 0; i < this.lineCount; i++) {
      ...
      if (line && line.blocks) {
        ...
        for (let j = 0; j < line.blocks.length; j++) {
          ...
          if (textStroke && block.strokeWidth > 0) {
